...
//     const newData=applied.filter(ele=>ele.jobs_id!==jobs_id);
...
//                     <a href=${ele.applyhere} target="_blank" type="button" class="btn btn-success my-2">Apply Now</a>
//                     <button href=${removeApplic(ele.jobs_id)} target="_blank" type="button" class="btn btn-success my-2">Remove </button><hr>
...
<br>
                ...
                <a href=${ele.applyhere} target="_blank" type="button" class="btn btn-success my-2">Apply Now</a>
                <button target="_blank" type="button" class="btn btn-success my-2">Remove </button><hr>
