// const studentData = (localStorage.getItem("newStud"));
const studentData={
    name:"Ronak Jain",
    department:"CSE",
    course: "B. Tech",
    email:"ronak@mail.com",
    cpi:8.2,
    roll:"2101CS67"
}
...
const setData = async () => {
    ...
    document.getElementById("stud-name").innerHTML = studentData.name ? studentData.name : "NO Data ";
    document.getElementById("department").innerHTML = studentData.department ? studentData.department : "CSE";
...
const saveChanges = async () => {
    ...
    new_data.username != "" ? studentData["name"] = new_data["username"] : {};
    ...
    localStorage.setItem("newStud", (studentData));
...
<div id="department" class="col-sm-9 text-secondary">
    <!-- Contact Number  -->    ${studentData.department}
...
<div id="course" class="col-sm-9 text-secondary">
    <!-- Contact Number  -->    ${studentData.course}
...
<div id="roll" class="col-sm-9 text-secondary">
    <!-- Contact Number  -->    ${studentData.name}
...
const logout = async () => {
    localStorage.removeItem("newStud");
